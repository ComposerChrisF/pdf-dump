...
fn collect_outline_items_inner(
    doc: &Document,
    first_id: ObjectId,
    ...
    while let Some(id) = current_id {
        ...
        current_id = dict.get(b"Next").ok().and_then(|v| v.as_reference().ok());
    }
...
fn count_outline_items(items: &[OutlineItem]) -> usize {
    items
        .iter()
        .map(|item| 1 + count_outline_items(&item.children))
        .sum()
}
...
mod tests {
    ...
    fn bookmarks_with_uri_action() {
        ...
        bm.set(
            "Title",
            Object::String(b"Link".to_vec(), StringFormat::Literal),
        );
    ...
    fn bookmarks_cycle_detection() {
        ...
        bm_b.set(
            "Title",
            Object::String(b"B".to_vec(), StringFormat::Literal),
        );
    ...
    fn bookmarks_with_goto_action() {
        ...
        bm.set(
            "Title",
            Object::String(b"Internal".to_vec(), StringFormat::Literal),
        );
    ...
    fn bookmarks_with_named_dest() {
        ...
        bm.set(
            "Title",
            Object::String(b"Named".to_vec(), StringFormat::Literal),
        );
    ...
    fn bookmarks_with_string_dest() {
        ...
        bm.set(
            "Title",
            Object::String(b"StrDest".to_vec(), StringFormat::Literal),
        );
        bm.set(
            "Dest",
            Object::String(b"page1dest".to_vec(), StringFormat::Literal),
        );
        let bm_id = doc.add_object(Object::Dictionary(bm));
    ...
    fn bookmarks_with_unknown_action() {
        ...
        bm.set(
            "Title",
            Object::String(b"JSAction".to_vec(), StringFormat::Literal),
        );
        bm.set("A", Object::Dictionary(action));
        let bm_id = doc.add_object(Object::Dictionary(bm));
